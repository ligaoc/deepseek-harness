...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-output-alert OutputAlertRow id \'output-alert\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins VisionBridgeCard id \'vision-bridge\'',
      'client-ui-settings-plugins AutoUpdateCard id \'auto-update\'',
    ],
    replaceRisk: 'none',
